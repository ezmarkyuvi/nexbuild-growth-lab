...
const getChannels = (isMobile: boolean) => {
  ...
  return [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/company/nex-build-labs",
      icon: (
    ...
    },
    {
      ...
      brandColor: "#FF0000",
      start: { x: 400 * s, y: 200 * s },
      end: { x: 260 * s, y: 110 * s },
    },
    {
      name: "Facebook",
      url: "https://www.facebook.com/share/14JGG3VGaUJ/",
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5 md:w-6 md:h-6" fill="currentColor">
