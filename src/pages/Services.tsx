    ...
    {services.map((service, i) => (
      <section key={service.title} className={`py-24 ${i % 2 === 1 ? "bg-secondary" : ""}`}>
        <div className="container mx-auto px-4 lg:px-8">
          <AnimatedSection>
            <div className="bg-card border border-border rounded-3xl p-8 md:p-12 shadow-card hover:shadow-card-hover hover:border-accent/20 hover:-translate-y-1 transition-all duration-300">
